...
- [ ] `relations`: расширить CHECK link_type — `+ supersedes, supports, member_of, part_of, describes_cluster` (`005_relations.sql:19-33`); unique index на `(target_name, link_type)` WHERE target_id IS NULL
